    ...
    >
      <div class="flex flex-row gap-2 w-auto">
        <div x-data title="Random">
          <svg
            id="random-button"
            @click="markmapStore.randomTheme()"
